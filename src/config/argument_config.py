...
class ArgumentConfig(PrintableConfig):
    ...
    output_name: Annotated[Optional[str], tyro.conf.arg(aliases=["-n"])] = None  # custom output filename (without extension). If None, auto-generate from source and driving filenames
